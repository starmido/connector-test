Assign alignment tasks
======

### New Task

The project manager selects a project in the project list of "Personal Center-Corpus Alignment-Alignment Management-My Projects" and clicks "Operation-Task" to jump to the task list page of the project.

![altalt](/images/对齐管理/使用说明/分配对齐任务-1708-360058486734.png)![](/images/对齐管理/使用说明/分配对齐任务-1709-360059390453.png)

Click New Task, select the aligned document type, and click Next.
